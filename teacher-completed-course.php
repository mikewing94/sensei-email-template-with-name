...
<h2 style="<?php echo esc_attr( $small ); ?>"><?php echo 'NOK Number:'; $user = get_user_by( 'id', $learner_id ); echo $user->nok_number; ?></h2>
...
<p style="<?php echo esc_attr( $small ); ?>"><?php printf( __( 'Manage this course\'s inductees %1$shere%2$s.', 'woothemes-sensei' ), '<a href="http://veja-mate.smchse.com/inductees/">', '</a>' ); ?></p>
