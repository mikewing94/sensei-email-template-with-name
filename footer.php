                                                ...
                                                <table border="0" cellpadding="10" cellspacing="0" width="100%">
                                                    <tr>
                                                        <td colspan="2" valign="middle" id="credit" style="<?php echo $credit; ?>">
                                                        	...
                                                        	<?php echo "Powered by ";?><a href="http://resolutiontelevision.com/">Resolution TV</a><?php echo " Unsubscribe from future DSM emails: ";?>
                                                        	<?php echo "<a href='http://dsm-induction.com/unsubscribe'>";
																  echo "Unsubscribe";
																  echo "</a>";?>
                                                        </td>
                                                    </tr>
